...
extension CalendarView {
    ...
    func setupNewLayout(from oldLayout: CalendarLayoutProtocol) {
        
        let newLayout = CalendarLayout(withDelegate: self)
