...
extension CalendarView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        calendarDelegate!.calendar(self, willDisplay: cell as! CalendarCell, forItemAt: cellState.date, cellState: cellState, indexPath: indexPath)
    }
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let delegate = calendarDelegate else {
            print("Your delegate does not conform to CalendarViewDelegate")
            assert(false)
