...
extension CalendarView {
    ...
    public func cellStatus(for date: Date) -> CellState? {
        ...
        let cell = cellForItem(at: paths[0]) as? CalendarCell
    ...
    public func cellStatus(at point: CGPoint) -> CellState? {
        if let indexPath = indexPathForItem(at: point) {
            let cell = cellForItem(at: indexPath) as? CalendarCell
    ...
    public func dequeueReusableJTAppleSupplementaryView(withReuseIdentifier identifier: String, for indexPath: IndexPath) -> CollectionReusableView {
    ...
    public func dequeueReusableCalendarCell(withReuseIdentifier identifier: String, for indexPath: IndexPath) -> CalendarCell {
        guard let cell = dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as? CalendarCell else {
